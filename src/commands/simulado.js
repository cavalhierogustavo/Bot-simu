...
const command = new SlashCommandBuilder()
  ...
  .addIntegerOption(option => option.setName('vagas').setDescription('Número de vagas').setRequired(true).addChoices({ name: '2', value: 2 },{ name: '4', value: 4 },{ name: '8', value: 8 }, { name: '16', value: 16 }, { name: '32', value: 32 }, { name: '64', value: 64 }))
